...
{
    [DataContract]
    public class DetailedEmployeeViewModel: EmployeeViewModel
    {
        ...
        public DetailedEmployeeViewModel()
        { }

        public DetailedEmployeeViewModel(Employee employee): base(employee)
        {
